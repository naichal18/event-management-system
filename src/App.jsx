...
import PendingEvents from './components/Admin/Pages/PendingEvents';
...
import ChatbotPage from './components/User/Pages/ChatbotPage';
...
const ProtectedRoute = ({ children, allowedRole }) => {
  ...
  if (allowedRole && user.role !== allowedRole) {
    return <Navigate to={user.role === 'Admin' ? '/admin' : '/user/home'} />;
  }
