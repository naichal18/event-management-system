...
export const AuthProvider = ({ children }) => {
  ...
  const register = async (userData) => {
    try {
      console.log('Frontend: Attempting Signup with:', userData);
  ...
  return (
    <AuthContext.Provider value={{ user, token, login, logout, register, updateProfile, changePassword, loading, API_BASE }}>
      {children}
